                ...
                <li className="clearfix" key={this_key}>
                  <div className="row">
                    <div className="col-sm-8">
                      <input disabled={this.props.isSystemField} tabIndex={index+1} className="form-control" style={{width: '100%'}} type="text" name={'label_'+index} placeholder="Option Label" value={option.label} onBlur={this.updateOption.bind(this)} onChange={this.editOption.bind(this, index)} />
                    </div>
                    <div className="col-sm-1">
                      <input disabled={this.props.isSystemField} className="form-control" type="checkbox" value="1" onChange={this.editOptionDefault.bind(this, index)} checked={option.hasOwnProperty("default")} />
                    </div>
                    <div className="col-sm-3">
                      <div className="dynamic-options-actions-buttons">
                        <button disabled={this.props.isSystemField} onClick={this.addOption.bind(this, index)} className="btn btn-success"><i className="fa fa-plus-circle"></i></button>
                        { index > 0 &&
                          <button disabled={this.props.isSystemField} onClick={this.removeOption.bind(this, index)} className="btn btn-danger"><i className="fa fa-minus-circle"></i></button>
                        }
                      </div>
                    </div>
                  </div>
